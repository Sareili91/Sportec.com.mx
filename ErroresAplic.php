...
class ErroresAplic{
	...
	CONST ARCH_PROBL = 12;
	CONST OPE_DESCONOCIDA = 13;
	CONST OPE_NO_REALIZADA = 14;
	CONST TIPO_PROD_INEXISTENTE = 15;
	CONST TIPO_EMPL_INEXISTENTE = 16;
	...
	$sMsjError = "";
		switch ($this->nError){
			...
			case self::ARCH_PROBL: $sMsjError = "El archivo presenta problemas";
									break;
			case self::OPE_DESCONOCIDA: $sMsjError = "La operación solicitada no existe";
									break;
			case self::OPE_NO_REALIZADA: $sMsjError = "La operación solicitada no se realizó";
									break;
			case self::TIPO_PROD_INEXISTENTE: $sMsjError = "No existe el tipo de producto solicitado";
									break;
			case self::TIPO_EMPL_INEXISTENTE: $sMsjError = "No existe el tipo de empleado solicitado";
									break;
