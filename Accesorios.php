...
private static $arrDisciplinas=array(
	...
	public function buscar():bool {
		throw new Exception("Accesorio->buscar: no implementada");
	}
	...
	$arrRet=array();
		...
		if ($this->nDisciplina<=0)
			throw new Exception("Accesorio->buscarTodosFiltro: faltan datos");
		else{
			if ($oAccesoDatos->conectar()){
				$sQuery = "SELECT t1.nClave, t1.sNombre, t1.sDescripcion,
                                  t1.sTalla, t1.sMaterial, t1.nDisciplina, 
	...
	public function insertar():int {
		throw new Exception("Accesorio->insertar: no implementada");
	}

	public function modificar():int {
		throw new Exception("Accesorio->modificar: no implementada");
	}

	public function eliminar():int {
		throw new Exception("Accesorio->eliminar: no implementada");
	}
